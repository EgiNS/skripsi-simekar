    ...
    <select wire:model.live="perPage" id="{{ $tableName }}-perPage"
        {{ 
            ...
            ->class([
                ...
                'block p-2 w-full rounded-md shadow-sm transition duration-150 ease-in-out sm:text-sm sm:leading-5 focus:ring focus:ring-opacity-50' => $this->isTailwind && $this->getPerPageFieldAttributes()['default-styling'],
