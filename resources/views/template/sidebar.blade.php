    ...
    <aside class="max-w-62.5 ease-nav-brand z-990 fixed inset-y-0 my-4 ml-4 block w-full -translate-x-full flex-wrap items-center justify-between overflow-y-auto rounded-2xl border-0 bg-white p-0 antialiased shadow-none transition-transform duration-200 xl:left-0 xl:translate-x-0 xl:bg-transparent">
        ...
        <div class="items-center block w-auto max-h-screen overflow-auto h-full grow basis-full">
          <ul class="flex flex-col pl-0 mb-0">
            ...
            <li class="mt-0.5 w-full" 
                x-data="{ open: {{ request()->routeIs('tabel-abk') ? 'true' : 'false' }} }">
                ...
                class="py-2.7 text-sm ease-nav-brand my-0 mx-4 flex items-center justify-between whitespace-nowrap px-4 transition-colors cursor-pointer 
                        {{ request()->routeIs('tabel-abk') ? 'rounded-lg bg-white font-semibold text-slate-700 shadow-soft-xl' : '' }}">
                    <div class="flex items-center">
                        <div class="{{ request()->routeIs('tabel-abk') ? 'bg-gradient-to-tl from-purple-700 to-pink-500' : '' }} shadow-soft-2xl mr-2 flex h-8 w-8 items-center justify-center rounded-lg bg-white bg-center stroke-0 text-center xl:p-2.5">
                                    ...
                                    <g transform="translate(-1869.000000, -293.000000)" fill="#FFFFFF" fill-rule="nonzero">
                                        <g transform="translate(1716.000000, 291.000000)">
                                            <g transform="translate(153.000000, 2.000000)">
                                                <path class="{{ request()->routeIs('tabel-abk') ? '' :  'fill-slate-800 '}} opacity-60" d="M12.25,17.5 L8.75,17.5 L8.75,1.75 C8.75,0.78225 9.53225,0 10.5,0 L31.5,0 C32.46775,0 33.25,0.78225 33.25,1.75 L33.25,12.25 L29.75,12.25 L29.75,3.5 L12.25,3.5 L12.25,17.5 Z"></path>
                                                <path class="{{ request()->routeIs('tabel-abk') ? '' :  'fill-slate-800'}}" d="M40.25,14 L24.5,14 C23.53225,14 22.75,14.78225 22.75,15.75 L22.75,38.5 L19.25,38.5 L19.25,22.75 C19.25,21.78225 18.46775,21 17.5,21 L1.75,21 C0.78225,21 0,21.78225 0,22.75 L0,40.25 C0,41.21775 0.78225,42 1.75,42 L40.25,42 C41.21775,42 42,41.21775 42,40.25 L42,15.75 C42,14.78225 41.21775,14 40.25,14 Z M12.25,36.75 L7,36.75 L7,33.25 L12.25,33.25 L12.25,36.75 Z M12.25,29.75 L7,29.75 L7,26.25 L12.25,26.25 L12.25,29.75 Z M35,36.75 L29.75,36.75 L29.75,33.25 L35,33.25 L35,36.75 Z M35,29.75 L29.75,29.75 L29.75,26.25 L35,26.25 L35,29.75 Z M35,22.75 L29.75,22.75 L29.75,19.25 L35,19.25 L35,22.75 Z"></path>
                                            </g>
                                        </g>
                                    </g>
                                </g>
                ...
                <ul x-show="open" x-transition class="ml-10 mt-1 space-y-0">
                    ...
                    <li>
                        <a href="#" class="block border-l-2 py-2 px-4 text-sm hover:bg-gray-100">Submenu 2</a>
                    </li>
                    <li>
